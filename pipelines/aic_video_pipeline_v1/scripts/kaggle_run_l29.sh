...
# L29 MP4 files are already mounted as a read-only Kaggle Input.  Reuse one
# resident AutoShot/FG-CLIP2 process and never download/copy the video archive.
export AIC_VIDEO_ROOT="${AIC_VIDEO_ROOT:-/kaggle/input/datasets/miphu2005/aic2026-videos-l21-a/Videos_L29_a/video}"
